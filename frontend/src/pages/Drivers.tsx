              ...
              <CardContent className="p-6 max-h-[70vh] overflow-y-auto space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <Input id="phone" placeholder="+1-555-0199" {...register("phone")} />
                ...
                <div className="grid gap-1.5">
                  ...
                  <Input id="address" placeholder="123 Road, NY" {...register("address")} />
                ...
                <div className="border-t pt-4 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="grid gap-1.5">
                      ...
                      <Input id="emergencyContactPhone" placeholder="+1-555-0198" {...register("emergencyContactPhone")} />
