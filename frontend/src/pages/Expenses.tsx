...
const Expenses: React.FC = () => {
  ...
  const [expenseLogs, setExpenseLogs] = React.useState<ExpenseLog[]>([
    { id: 1, date: "2026-07-12", vehicleId: 1, driverId: 1, amount: 456.00, category: "Fuel", volumeLitres: 120, location: "Love's #412, GJ", notes: "Full tank top-up" },
    { id: 2, date: "2026-07-11", vehicleId: 2, driverId: 2, amount: 1250.00, category: "Maintenance", location: "Fleet Mechanic Group, MH", notes: "Brake service invoice" },
    { id: 3, date: "2026-07-10", vehicleId: 1, driverId: 1, amount: 180.00, category: "Lodging", location: "Motel 6, MH", notes: "Overnight layover during transit" },
    { id: 4, date: "2026-07-09", vehicleId: 3, driverId: 3, amount: 85.00, category: "Tolls", location: "EZ-Pass GJ Tolls", notes: "Bridge vectors crossing" },
  ]);

  const onExpenseSubmit = (data: ExpenseFormValues) => {
    const newLog: ExpenseLog = {
      id: expenseLogs.length + 1,
      date: data.date,
      vehicleId: data.vehicleId,
      driverId: data.driverId,
      amount: data.amount,
      category: data.category as any,
      volumeLitres: data.category === "Fuel" ? data.volumeLitres : undefined,
