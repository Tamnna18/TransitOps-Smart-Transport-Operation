...
const Dashboard: React.FC = () => {
  ...
  const recentActivities = [
    { id: 1, action: "Vehicle Added", desc: "Freightliner Cascadia #NY-9942-TX registered by Safety Officer", time: "2 hours ago", icon: Truck, color: "text-blue-500 bg-blue-500/10" },
    { id: 2, action: "Driver Registered", desc: " Bruce Banner added to driver roster with CDL class A", time: "4 hours ago", icon: Users, color: "text-emerald-500 bg-emerald-500/10" },
    { id: 3, action: "Scheduled Maintenance", desc: "Vehicle #NJ-1142-FL sent to workshop for brake pads inspection", time: "1 day ago", icon: Wrench, color: "text-amber-500 bg-amber-500/10" },
    { id: 4, action: "Fuel Log Added", desc: "Driver John Doe logged 120 Gal diesel fuel purchase", time: "1 day ago", icon: DollarSign, color: "text-sky-500 bg-sky-500/10" },
  ];

  const alerts = [
    { id: 1, type: "expiry", title: "Insurance Expiry Alert", desc: "Volvo VNL 860 (#PA-8853-RD) insurance policy expires in 12 days.", status: "warning" },
    { id: 2, type: "licence", title: "CDL License Expired", desc: "Driver Walter White is currently suspended due to license expiry.", status: "destructive" },
    { id: 3, type: "maintenance", title: "Overdue Vehicle Inspection", desc: "Kenworth T680 (#NJ-1142-FL) missed scheduled fitness checking.", status: "warning" },
  ];
