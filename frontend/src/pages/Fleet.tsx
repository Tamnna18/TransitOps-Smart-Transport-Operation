                ...
                filteredVehicles.map((vehicle) => {
                  ...
                  return (
                    <tr key={vehicle.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-6 py-4 text-xs font-medium">{vehicle.capacity.toLocaleString()} kg</td>
                      <td className="px-6 py-4 text-xs font-mono">{vehicle.currentOdometer.toLocaleString()} km</td>
                      <td className="px-6 py-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                ...
                <div>
                  ...
                  <span className="font-semibold text-foreground flex items-center gap-1"><Scale className="h-3.5 w-3.5" /> {selectedVehicle.capacity.toLocaleString()} kg</span>
                </div>
                <div>
              ...
              <CardContent className="p-6 max-h-[70vh] overflow-y-auto space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-1.5">
                    ...
                    <Input id="licensePlate" placeholder="GJ-9942-TX" {...register("licensePlate")} />
                    {errors.licensePlate && <p className="text-xs text-destructive">{errors.licensePlate.message}</p>}
                  </div>
                  <div className="grid gap-1.5">
                    <Label htmlFor="name">Vehicle Name</Label>
                    <Input id="name" placeholder="Tata Prima" {...register("name")} />
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="grid gap-1.5">
                    ...
                    <Input id="make" placeholder="BharatBenz" {...register("make")} />
                    {errors.make && <p className="text-xs text-destructive">{errors.make.message}</p>}
                  </div>
                  <div className="grid gap-1.5">
                    <Label htmlFor="model">Model</Label>
                    <Input id="model" placeholder="3528C" {...register("model")} />
