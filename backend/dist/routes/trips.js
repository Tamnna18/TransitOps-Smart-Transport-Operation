...
// POST add trip
router.post("/", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER"]), async (req, res) => {
    const data = req.body;
    try {
        const timeline = [
            {
...
router.put("/:id", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER"]), async (req, res) => {
    const { id } = req.params;
    const data = req.body;
    try {
...
router.put("/:id/dispatch", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER", "DRIVER"]), async (req, res) => {
    const { id } = req.params;
    try {
...
router.put("/:id/complete", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER", "DRIVER"]), async (req, res) => {
    const { id } = req.params;
...
router.put("/:id/cancel", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER", "DRIVER"]), async (req, res) => {
    const { id } = req.params;
