...
router.post("/", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER", "SAFETY", "DRIVER"]), async (req, res) => {
    const data = req.body;
    try {
...
router.put("/:id/resolve", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER", "SAFETY"]), async (req, res) => {
    const { id } = req.params;
...
router.get("/dvir", authMiddleware_1.authenticateToken, async (req, res) => {
    try {
...
router.post("/dvir", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER", "SAFETY", "DRIVER"]), async (req, res) => {
    const data = req.body;
    try {
...
router.get("/incidents", authMiddleware_1.authenticateToken, async (req, res) => {
    try {
...
router.post("/incidents", authMiddleware_1.authenticateToken, (0, authMiddleware_1.requireRole)(["MANAGER", "SAFETY", "DRIVER"]), async (req, res) => {
    const data = req.body;
    try {
